...
export function EventFeed({ events, videoTimes, onEventHover, onEventClick }: EventFeedProps) {
  ...
  return (
    <div className="relative flex flex-col space-y-4">
      <h2 className="text-2xl font-bold text-slate-900 tracking-tight">Recent Incidents</h2>
      <AnimatePresence>
        {visibleEvents.map((event) => {
          ...
          return (
            <motion.div
              ...
              className="relative rounded-xl border border-slate-200 bg-white shadow-sm border-l-4 border-l-red-500"
            >
              <div className="p-4">
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex-1 space-y-1">
                    <p className="font-medium text-slate-900 leading-none">{event.camera.name}</p>
