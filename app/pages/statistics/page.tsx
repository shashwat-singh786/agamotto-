...
export default function StatisticsPage() {
  ...
  return (
    <div className="flex-1 w-full flex flex-col gap-8 items-center p-8 bg-slate-50 min-h-screen">
      <div className="w-full max-w-6xl flex flex-col gap-8">
        {/* Charts Section */}
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="p-6 bg-white rounded-xl border border-slate-200 shadow-sm">
            <h2 className="text-xl font-semibold text-slate-900 mb-4">Dangerous Moments by Video</h2>
          ...
          <div className="p-6 bg-white rounded-xl border border-slate-200 shadow-sm">
            <h2 className="text-xl font-semibold text-slate-900 mb-4">Dangerous vs Non-Dangerous Moments</h2>
          ...
          <div className="p-6 bg-white rounded-xl border border-slate-200 shadow-sm">
            <h2 className="text-xl font-semibold text-slate-900 mb-4">Danger Trend Over Time</h2>
        ...
        <div className="flex justify-between items-center">
          <h1 className="text-3xl font-bold text-slate-900">Video Key Moments</h1>
          <Button
            onClick={exportToCSV}
            variant="outline"
              ...
              {table.getHeaderGroups().map((headerGroup) => (
                <tr key={headerGroup.id}>
                  {headerGroup.headers.map((header) => (
                    <th key={header.id} className="px-4 py-3 text-left bg-slate-50 text-slate-600 text-sm font-semibold">
        ...
        <div className="mt-8 p-6 bg-white rounded-xl border border-slate-200 shadow-sm">
          <h2 className="text-2xl font-semibold text-slate-900 mb-4">AI Analysis Summary</h2>
          {isLoadingSummary ? (
